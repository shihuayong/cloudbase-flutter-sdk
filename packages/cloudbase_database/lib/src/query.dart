...
class Query {
  ...
  Future<CloudBaseResponse> _queryRequest(String action, Map<String, dynamic> params) {
    params.addAll({
  ...
  Future<DbQueryResponse> get() async {
    ...
    if (this._queryOptions.limit != null) {
      params['limit'] = this._queryOptions.limit < 1000 ? this._queryOptions.limit : 1000;
    } else {
    ...
    CloudBaseResponse res = await _queryRequest('database.queryDocument', params);
    if (res.code != null) {
  ...
  Future<DbQueryResponse> count() async {
    ...
    CloudBaseResponse res = await _queryRequest('database.countDocument', params);
    if (res.code != null) {
      return DbQueryResponse(
        code: res.code,
        message: res.message,
  ...
  Future<DbUpdateResponse> update(Map<String, dynamic> data) async {
    ...
    CloudBaseResponse res = await _queryRequest('database.updateDocument', params);
    if (res.code != null) {
      return DbUpdateResponse(
        code: res.code,
        message: res.message,
  ...
  Future<DbRemoveResponse> remove() async {
    ...
    CloudBaseResponse res = await _queryRequest('database.deleteDocument', params);
    if (res.code != null) {
      return DbRemoveResponse(
        code: res.code,
        message: res.message,
