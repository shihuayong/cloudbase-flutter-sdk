...
class Document {
  ...
  /// 请求句柄
  CloudBaseRequest _request;

  Document({CloudBaseCore core, String coll, dynamic docId, Map<String, dynamic> projection}) {
    _core = core;
    _coll = coll;
    _id = docId;
  ...
  Future<CloudBaseResponse> _docRequest(String action, Map<String, dynamic> params) {
    params.addAll({
  ...
  Future<DbCreateResponse> create(dynamic data) async {
    ...
    if (res.code != null) {
      return DbCreateResponse(code: res.code, message: res.message, requestId: res.requestId);
    }
  ...
  Future<DbUpdateResponse> set(dynamic data) async {
    ...
    CloudBaseResponse res = await _docRequest('database.updateDocument', params);
    if (res.code != null) {
      return DbUpdateResponse(code: res.code, message: res.message, requestId: res.requestId);
    }
  ...
  Future<DbRemoveResponse> remove() async {
    ...
    CloudBaseResponse res = await _docRequest('database.deleteDocument', params);
    if (res.code != null) {
      return DbRemoveResponse(code: res.code, message: res.message, requestId: res.requestId);
    }
  ...
  Future<DbQueryResponse> get() async {
    ...
    if (res.code != null) {
      return DbQueryResponse(code: res.code, message: res.message, requestId: res.requestId);
    }
