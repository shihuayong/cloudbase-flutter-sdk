...
class CloseEventInfo {
  ...
  CloseEventInfo({this.code, this.name, this.description});
}
...
class CloseEventCode {
  // spec
  static const num NormalClosure = 1000;
  static const num GoingAway = 1001;
  static const num ProtocolError = 1002;
  static const num UnsupportedData = 1003;
  static const num NoStatusReceived = 1005;
  static const num AbnormalClosure = 1006;
  static const num InvalidFramePayloadData = 1007;
  static const num PolicyViolation = 1008;
  static const num MessageTooBig = 1009;
  static const num MissingExtension = 1010;
  static const num InternalError = 1011;
  static const num ServiceRestart = 1012;
  static const num TryAgainLater = 1013;
  static const num BadGateway = 1014;
  static const num TLSHandshake = 1015;
  // custom - client close itself
  static const num ReconnectWebSocket = 3000;
  static const num NoRealtimeListeners = 3001;
  static const num HeartbeatPingError = 3002;
  static const num HeartbeatPongTimeoutError = 3003;
  // custom - server close
  static const num NoAuthentication = 3050;
}

CloudBaseException getWSCloseError (num code, String reason) {
